...
# Vinculamos el security group al interface de red (NIC)
...
resource "azurerm_network_interface_security_group_association" "mySecGroupAssociationWorkers" {
    ...
    network_security_group_id = azurerm_network_security_group.mySecGroupWorkers.id
